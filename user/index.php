...
<body>
  ...
  <br>
    <button class="pull-right btn-success"><a href="file_case.php">File a Case</a></button>
   <div class="panel panel-default">
    <div class="panel-heading" style="background-color: #008000;">
              <h3 class="panel-title" style="color: white;">Federal High Court Makurdi Cases </h3>
            </div>
...
?>
          <tr>
            ...
            <td ><?php echo $case_no; ?></td>
             ...
             <td ><?php echo $date; ?></td>
                <td><a href="view_case.php?id=<?php echo $id; ?>" class="btn btn-success">View More</a></td>
          </tr>
